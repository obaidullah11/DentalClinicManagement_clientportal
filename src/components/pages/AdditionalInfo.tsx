          ...
          <div className="w-full lg:w-[737px] flex flex-col h-full">
            ...
            <div className="flex-1 flex flex-col w-full h-full min-h-0">
              ...
              <div className="mb-8">
                ...
                <textarea value={bookingData.notes} onChange={(e) => updateBookingData('notes', e.target.value)} placeholder="Notes" className="w-full px-3 py-2 border border-gray-300 rounded-md text-sm h-20 resize-none"></textarea>
              </div>
